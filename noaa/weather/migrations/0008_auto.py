...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'WBAN', fields ['disabled']
        db.create_index(u'weather_wban', ['disabled'])


    def backwards(self, orm):
        # Removing index on 'WBAN', fields ['disabled']
        db.delete_index(u'weather_wban', ['disabled'])
