...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'WBAN', fields ['callsign']
        db.delete_unique(u'weather_wban', ['callsign'])


    def backwards(self, orm):
        # Adding unique constraint on 'WBAN', fields ['callsign']
        db.create_unique(u'weather_wban', ['callsign'])
